<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            <div>
                <p class="text-xs uppercase tracking-[0.25em] text-slate-500">courses</p>
            </div>
            <x-hyper-link href="{{route('courses.create')}}">Create</x-hyper-link>
        </div>
    </x-slot>
                                ...
                                <article class="group flex h-full flex-col overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-slate-200 transition hover:-translate-y-1 hover:shadow-2xl">
                                    ...
                                    <div class="flex flex-1 flex-col gap-3 px-5 pb-6 pt-5">
                                        ...
                                        <div class="mt-auto space-y-3">
                                            ...
                                            <div class="space-x-2">
                                                <x-hyper-link href="{{route('courses.show',$course->slug)}}">Enroll</x-hyper-link>
